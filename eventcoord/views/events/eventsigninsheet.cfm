	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<cfif ListLen(Session.SignInSheet.EventDates) GTE 2 and not isDefined("URL.EventDatePOS")>
				<table class="table" width="100%" cellspacing="0" cellpadding="0">
					<tr>
						<cfif ListLen(Session.SignInSheet.EventDates) GTE 1><td><A Href="#buildURL('eventcoord:events.eventsigninsheet', cgi.path_info)#&EventID=#URL.EventID#&EventDatePos=1">SignIn Sheet Day 1</a></td></cfif>
						<cfif ListLen(Session.SignInSheet.EventDates) GTE 2><td><A Href="#buildURL('eventcoord:events.eventsigninsheet', cgi.path_info)#&EventID=#URL.EventID#&EventDatePos=2">SignIn Sheet Day 2</a></td></cfif>
						<cfif ListLen(Session.SignInSheet.EventDates) GTE 3><td><A Href="#buildURL('eventcoord:events.eventsigninsheet', cgi.path_info)#&EventID=#URL.EventID#&EventDatePos=3">SignIn Sheet Day 3</a></td></cfif>
						<cfif ListLen(Session.SignInSheet.EventDates) GTE 4><td><A Href="#buildURL('eventcoord:events.eventsigninsheet', cgi.path_info)#&EventID=#URL.EventID#&EventDatePos=4">SignIn Sheet Day 4</a></td></cfif>
						<cfif ListLen(Session.SignInSheet.EventDates) GTE 5><td><A Href="#buildURL('eventcoord:events.eventsigninsheet', cgi.path_info)#&EventID=#URL.EventID#&EventDatePos=5">SignIn Sheet Day 5</a></td></cfif>
					</tr>
					<tr>
						<td colspan="5"></td>
					</tr>
		...
		<cfif isDefined("URL.EventDatePOS")>
			<div class="panel-footer">
				...
				<a href="#buildURL('eventcoord:events.eventsigninsheet&EventID=#URL.EventID#', cgi.path_info)#" class="btn btn-primary pull-right">View Another Day's SignIn Sheet</a><br /><br />
			</div>
		<cfelse>
			<div class="panel-footer">
...
<cfoutput>
	...
	<cfif ListLen(Variables.EventDates) GTE 2 and not isDefined("URL.EventDatePOS")>
		<Table style="border-width: 3px; border-spacing: 1px; border-style: outset; border-color: gray; border-collapse: separate; background-color: ##EDEDED;" Align="Center" Width="100%">
			<tr>
				<cfif ListLen(Variables.EventDates) GTE 1><td Style="border-width: 0px; padding: 1px; border-style: inset; border-color: gray; background-color: ##EDEDED; -moz-border-radius: ; Font-Family: Arial; Font-Size: 14px; Font-Weight: Normal;"><A Href="#buildURL('eventcoord:events.eventsigninsheet', cgi.path_info)#&EventID=#URL.EventID#&EventDatePos=1">SignIn Sheet Day 1</a></td></cfif>
				<cfif ListLen(Variables.EventDates) GTE 2><td Style="border-width: 0px; padding: 1px; border-style: inset; border-color: gray; background-color: ##EDEDED; -moz-border-radius: ; Font-Family: Arial; Font-Size: 14px; Font-Weight: Normal;"><A Href="#buildURL('eventcoord:events.eventsigninsheet', cgi.path_info)#&EventID=#URL.EventID#&EventDatePos=2">SignIn Sheet Day 2</a></td></cfif>
				<cfif ListLen(Variables.EventDates) GTE 3><td Style="border-width: 0px; padding: 1px; border-style: inset; border-color: gray; background-color: ##EDEDED; -moz-border-radius: ; Font-Family: Arial; Font-Size: 14px; Font-Weight: Normal;"><A Href="#buildURL('eventcoord:events.eventsigninsheet', cgi.path_info)#&EventID=#URL.EventID#&EventDatePos=3">SignIn Sheet Day 3</a></td></cfif>
				<cfif ListLen(Variables.EventDates) GTE 4><td Style="border-width: 0px; padding: 1px; border-style: inset; border-color: gray; background-color: ##EDEDED; -moz-border-radius: ; Font-Family: Arial; Font-Size: 14px; Font-Weight: Normal;"><A Href="#buildURL('eventcoord:events.eventsigninsheet', cgi.path_info)#&EventID=#URL.EventID#&EventDatePos=4">SignIn Sheet Day 4</a></td></cfif>
				<cfif ListLen(Variables.EventDates) GTE 5><td Style="border-width: 0px; padding: 1px; border-style: inset; border-color: gray; background-color: ##EDEDED; -moz-border-radius: ; Font-Family: Arial; Font-Size: 14px; Font-Weight: Normal;"><A Href="#buildURL('eventcoord:events.eventsigninsheet', cgi.path_info)#&EventID=#URL.EventID#&EventDatePos=5">SignIn Sheet Day 5</a></td></cfif>
			</tr>
			<tr>
	...
	<cfelse>
		<cfquery name="getRegisteredParticipants" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
			SELECT eRegistrations.RequestsMeal, eRegistrations.IVCParticipant, tusers.Fname, tusers.Lname, tusers.Company, tusers.Email, dbo.SUBSTRING_INDEX(tusers.Email,'@',-1) AS Domain, p_eventregistration_events.ShortTitle, dbo.date_FORMAT(eEvents.EventDate, '%a, %M %d, %Y') as EventDateFormat
