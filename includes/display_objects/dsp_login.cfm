		...
		<div id="svLoginContainer" class="mura-login-container #this.loginWrapperClass#">
			<div class="#this.loginWrapperInnerClass#">
				...
				<cfif not variables.$.event('isBlocked')>
					...
					<form name="form2" class="mura-send-login #this.forgotPasswordFormClass# <cfif this.formWrapperClass neq "">#this.formWrapperClass#</cfif>" method="post" action="?nocache=1" id="forgotPassword">
						<fieldset>
							<legend>#variables.$.rbKey('user.forgetusernameorpassword')#</legend>
							<p align="center"><a href="http://#cgi.server_name#/?EventRegistrationaction=public:usermenu.forgotpassword" class="btn btn-primary btn-small" alt="Forgot Password">Click Here to retrieve password</a></p>
						</fieldset>
					</form>
					<br><br><br>
					<form name="form3" class="mura-send-login #this.forgotPasswordFormClass# <cfif this.formWrapperClass neq "">#this.formWrapperClass#</cfif>" method="post" action="" id="createAccount">
						<fieldset>
							<legend>Create Account</legend>
							<p align="center"><a href="http://#cgi.server_name#/?EventRegistrationaction=public:registeruser.default" class="btn btn-primary btn-small" alt="Create Account">Click Here to create account</a></p>
						</fieldset>
					</form>
