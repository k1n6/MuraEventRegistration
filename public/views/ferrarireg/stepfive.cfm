							...
							<div class="form-group row">
								...
								<div class="col-sm-6 pull-right text-align-right">
									...
									<cfelse>
										<a 
											...
											class="btn btn-primary">Complete Registration</a>
								...
								<cfif session.target_user_session.admin_user>
									<div class="col-sm-12 text-align-right">
										...
										<a 
											href="?EventRegistrationaction=public:ferrarireg.thankyou"
											class="btn btn-primary">Admin Checkout</a>*<br>
										*This feature is only available to admin users and completes the registration without going through a payment step.<br>
									</div>
								</cfif>
