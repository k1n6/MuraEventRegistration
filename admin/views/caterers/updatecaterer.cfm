				...
				<table class="table table-striped" cellspacing="0" cellpadding="0">
					...
					<tbody>
						<cfloop query="getAllFacilities">
							...
							<td width="110"><a href="#buildURL('admin:caterers.updatecaterer', cgi.path_info)#&PerformAction=Edit&RecNo=#getAllFacilities.TContent_ID#" class="btn btn-small">Edit</a>&nbsp;<a href="#buildURL('admin:caterers.updatecaterer', cgi.path_info)#&PerformAction=Delete&RecNo=#getAllFacilities.TContent_ID#" class="btn btn-small">Delete</a></td>
							</tr>
						</cfloop>
					</tbody>
				</table>
