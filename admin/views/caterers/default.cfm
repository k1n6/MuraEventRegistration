		...
		<div class="art-blockcontent">
			...
			<table class="art-article" style="width:100%;">
				...
				<cfif getAllCaterers.RecordCount>
					<tfoot>
						<tr>
							<td colspan="6">Add new Catering Business not listed above by clicking <a href="#buildURL('admin:caterers.addcaterer', cgi.path_info)#" class="art-button">here</a></td>
						</tr>
					</tfoot>
					<tbody>
						<cfloop query="getAllCaterers">
							...
							<td><a href="#buildURL('admin:caterers.updatecaterer', cgi.path_info)#&PerformAction=Edit&RecNo=#getAllCaterers.TContent_ID#" class="btn btn-warning btn-small">U</a>&nbsp;<a href="#buildURL('admin:caterers.updatecaterer', cgi.path_info)#&PerformAction=Delete&RecNo=#getAllCaterers.TContent_ID#" class="btn btn-danger btn-small">D</a></td>
							</tr>
						</cfloop>
					</tbody>
				<cfelse>
					<tbody>
						<tr>
							<td colspan="6"><div align="center" class="alert-box notice">No Catering Business has been added to this website. Please click <a href="#buildURL('admin:caterers.addcaterer', cgi.path_info)#" class="art-button">here</a> to add a new catering business.</div></td>
						</tr>
					</tbody>
				</cfif>
			</table>
