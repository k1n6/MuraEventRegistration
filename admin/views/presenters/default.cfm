...
<cfoutput>
	...
	<table class="art-article" style="width:100%;">
		...
		<cfif getAllPresenters.RecordCount>
			<tfoot>
				<tr>
					<td colspan="6">Add new Membership Organization not listed above by clicking <a href="#buildURL('admin:membership.addorganization', cgi.path_info)#" class="art-button">here</a></td>
				</tr>
			</tfoot>
			<tbody>
				<cfloop query="getAllPresenters">
					...
					<td><a href="#buildURL('admin:presenters.updateuser', cgi.path_info)#&PerformAction=Edit&RecNo=#getAllPresenters.UserID#" class="art-button">U</a>&nbsp;<a href="#buildURL('admin:presenters.updateuser', cgi.path_info)#&PerformAction=Delete&RecNo=#getAllPresenters.UserID#" class="art-button">D</a></td>
					</tr>
				</cfloop>
			</tbody>
		<cfelse>
			<tbody>
				<tr>
					<td colspan="6" align="Center"><h4>No Presenters have been entered into this application. Please click <a class="art-button" href="#buildURL('admin:users.adduser', cgi.path_info)#">here</a> to add a presenter to this system.</h4></td>
				</tr>
			</tbody>
		</cfif>
	</table>
