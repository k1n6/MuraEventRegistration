...
<cfoutput>
	<div class="art-block clearfix">
		...
		<div class="art-blockcontent">
			...
			<hr>
			<uForm:form action="#buildURL('admin:events.addevent_review', cgi.path_info)#" method="Post" id="AddEvent" errors="#Session.FormErrors#" errorMessagePlacement="both"
				...
				<uForm:fieldset legend="Event Date and Time">
					<uform:field label="Primary Event Date <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="EventDate" isDisabled="true" value="#Session.UserSuppliedInfo.EventDate#" type="date" inputClass="date" hint="Date of Event, First Date if event has multiple dates." />
					...
					<uform:field label="Registration Deadline <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="Registration_Deadline" isDisabled="true" value="#Session.UserSuppliedInfo.Registration_Deadline#" type="date" inputClass="date" hint="Accept Registration up to this date" />
					<uform:field label="Registration Start Time <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="Registration_BeginTime" isDisabled="true" value="#Session.UserSuppliedInfo.Registration_BeginTime#" type="time" pluginSetup="#timeConfig#" hint="The Beginning Time onSite Registration begins" />
					<uform:field label="Event Start Time <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="Event_StartTime" isDisabled="true" type="time" value="#Session.UserSuppliedInfo.Event_StartTime#" pluginSetup="#timeConfig#" hint="The starting time of this event" />
					<uform:field label="Event End Time <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="Event_EndTime" isDisabled="true" type="time" value="#Session.UserSuppliedInfo.Event_EndTime#" pluginSetup="#timeConfig#" hint="The ending time of this event" />
				</uForm:fieldset>
				<uForm:fieldset legend="Event Description">
					<uform:field label="Event Short Title <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="ShortTitle" isDisabled="true" value="#Session.UserSuppliedInfo.ShortTitle#" maxFieldLength="50" type="text" hint="Short Event Title of Event" />
					<uform:field label="Event Description <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="LongDescription" isDisabled="true" value="#Session.UserSuppliedInfo.LongDescription#" type="textarea" hint="Description of this meeting or event" />
				</uForm:fieldset>
				<uForm:fieldset legend="Event Details">
					<uform:field label="Event Agenda <a href='#buildURL('admin:events.addevent_review##EditEventAgenda', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="EventAgenda" isDisabled="true" type="textarea" value="#Session.UserSuppliedInfo.EventAgenda#" hint="The Agenda if avaialble for this event." />
					<uform:field label="Event Target Audience <a href='#buildURL('admin:events.addevent_review##EditEventTargetAudience', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="EventTargetAudience" isDisabled="true" type="textarea" value="#Session.UserSuppliedInfo.EventTargetAudience#" hint="The Target Audience for this event. Who should come to this event" />
					<uform:field label="Event Strategies <a href='#buildURL('admin:events.addevent_review##EditEventStrategies', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="EventStrategies" isDisabled="true" type="textarea" value="#Session.UserSuppliedInfo.EventStrategies#" hint="The Strategies of this event, if any." />
					<uform:field label="Event Special Instructions <a href='#buildURL('admin:events.addevent_review##EditEventSpecialInstructions', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="EventSpecialInstructions" isDisabled="true" type="textarea" value="#Session.UserSuppliedInfo.EventSpecialInstructions#" hint="If available, any special instructions participants need." />
				</uForm:fieldset>
				...
				<cfif Session.UserSuppliedInfo.WebinarEvent EQ 0>
					<uForm:fieldset legend="Event Pricing">
						<uform:field label="Member Pricing <a href='#buildURL('admin:events.addevent_step2', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="MemberCost" isDisabled="true" type="text" value="#NumberFormat(Session.UserSuppliedInfo.MemberCost, '9999.99')#" hint="The cost for a member school district to attend per person." />
						<uform:field label="NonMember Pricing <a href='#buildURL('admin:events.addevent_step2', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="NonMemberCost" isDisabled="true" type="text" value="#NumberFormat(Session.UserSuppliedInfo.NonMemberCost, '9999.99')#" hint="The cost for a nonmember school district to attend per person." />
					</uForm:fieldset>
					<cfif Session.UserSuppliedInfo.ViewSpecialPricing EQ 1>
						...
						<uform:field label="Special Pricing Available <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="ViewSpecialPricing" type="text" isDisabled="true" value="#Variables.SpecialPrice_AvailableText#" hint="Does this event have special pricing available?" />
					...
					<cfif Session.UserSuppliedInfo.EarlyBird_RegistrationAvailable EQ 1>
						...
						<uform:field label="EarlyBird Registration Available <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="EarlyBird_RegistrationAvailable" type="text" isDisabled="true" value="#Variables.EarlyBird_AvailableText#" hint="Does this event have an EarlyBird Registration Cutoff Date/Price" />
					...
					<cfif Session.UserSuppliedInfo.MealAvailable EQ 1>
						...
						<uform:field label="Meal Provided <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="MealAvailable" type="text" isDisabled="true" value="#Variables.MealProvided_AvailableText#" hint="Does this event have a meal available to attendee(s)?" />
					...
					<cfif Session.UserSuppliedInfo.AllowVideoConference EQ 1>
						...
						<uform:field label="Allow Video Conference <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="AllowVideoConference" isDisabled="true" type="text" value="#Variables.AllowVideoConference_AvailableText#" hint="Can an attendee participate with Video Conference (IP Video)?" />
				...
				<cfif Session.UserSuppliedInfo.EventFeatured EQ 1>
					<uForm:fieldset legend="Event Featured">
						...
						<uform:field label="Event Featured <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="EventFeatured" type="text" isDisabled="true" value="#Variables.EventFeatured_AvailableText#" hint="Would this event be featured on the website?" />
				...
				<cfif Session.UserSuppliedInfo.PGPAvailable EQ 1>
					<uForm:fieldset legend="Professional Growth Points Information">
						...
						<uform:field label="PGP Points Available <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="PGPAvailable" type="text" isDisabled="true" value="#Variables.PGPAvailable_AvailableText#" hint="Does this event have PGP Points for Attendee(s)?" />
				...
				<cfif Session.UserSuppliedInfo.WebinarEvent EQ 1>
					<uForm:fieldset legend="Event Webinar Information">
						...
						<uform:field label="Allow Webinar Conference <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="WebinarEvent" isDisabled="true" type="text" value="#Variables.WebinarEvent_AvailableText#" hint="Can an attendee participate with Webinar Technology?" />
				...
				<cfif Session.UserSuppliedInfo.WebinarEvent EQ 0>
					...
					<uForm:fieldset legend="Facility Room Information">
						<uform:field label="Facility Location <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="LocationIDName" isDisabled="true" type="text" value="#GetFacilityInformation.FacilityName#" hint="Where is this facility being held at?" />
				...
				<cfif Session.UserSuppliedInfo.PostEventToFB EQ 1>
					<uForm:fieldset legend="Event Posting to Facebook">
						...
						<uform:field label="Post Event To Facebook <a href='#buildURL('admin:events.addevent', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>" name="PostEventToFB" type="text" isDisabled="true" value="#Variables.EventPostToFB_AvailableText#" hint="Would this event be posted to the Organization's Facebook Page?" />
					</uForm:fieldset>
