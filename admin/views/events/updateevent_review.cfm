	...
	<div class="art-block clearfix">
		...
		<div class="art-blockcontent">
			...
			<uForm:form action="" method="Post" id="UpdateEvent" errors="#Session.FormErrors#" errorMessagePlacement="both"
				...
				<uForm:fieldset legend="Event Date and Time  <a href='#buildURL('admin:events.updateevent_datetime', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>">
				...
				<uForm:fieldset legend="Event Description  <a href='#buildURL('admin:events.updateevent_description', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>">
				...
				<uForm:fieldset legend="Event Details  <a href='#buildURL('admin:events.updateevent_details', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>">
				...
				<uForm:fieldset legend="Event Speaker(s)  <a href='#buildURL('admin:events.updateevent_presenter', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>">
				...
				<uForm:fieldset legend="Event Pricing  <a href='#buildURL('admin:events.updateevent_pricing', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>">
				...
				<uForm:fieldset legend="Event Special Pricing Information  <a href='#buildURL('admin:events.updateevent_specialprice', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>">
				...
				<uForm:fieldset legend="Event Featured  <a href='#buildURL('admin:events.updateevent_featured', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>">
				...
				<uForm:fieldset legend="Event Early Bird Information  <a href='#buildURL('admin:events.updateevent_earlybirdinfo', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>">
				...
				<uForm:fieldset legend="Professional Growth Points Information  <a href='#buildURL('admin:events.updateevent_pgppoints', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>">
				...
				<uForm:fieldset legend="Event Meal Information  <a href='#buildURL('admin:events.updateevent_mealinfo', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>">
				...
				<uForm:fieldset legend="Video Conferencing Information  <a href='#buildURL('admin:events.updateevent_ivcinfo', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>">
				...
				<uForm:fieldset legend="Facility Room Information  <a href='#buildURL('admin:events.updateevent_facilityinfo', cgi.path_info)#' class='ui-icon ui-icon-pencil'></a>">
